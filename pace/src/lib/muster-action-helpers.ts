// Pure helpers shared by the Muster server actions, kept outside any "use server"
...
export function safeNextPath(value: FormDataEntryValue | null, fallback = "/muster") {
