...
import { paceDeleteActivityPostAction } from "@/app/actions/pace";
    ...
    <main className="pace-shell min-h-screen">
      ...
      <section className="profile-page mx-auto max-w-5xl px-5 pb-20 sm:px-8">
        ...
        <header className="profile-hero">
          ...
          <div>
            <p className="pace-kicker">{isOwnProfile ? "Your profile" : "Member profile"}</p>
        ...
        <div className="profile-layout">
          ...
          <section className="activity-feed" aria-labelledby="activity-feed-title">
            <div className="activity-feed-heading">
              <p className="pace-kicker">Feed</p>
              ...
              activityPosts.map((post) => {
                ...
                return (
                  <article className="activity-card" key={post.id}>
                        ...
                        <p>
                          {completed ? (
                            <>
                              ...
                              {plan ? <Link href={`/pace/plan/${plan.id}`}>{plan.title}</Link> : "a plan"}
                            </>
                          ) : (
                    ...
                    {plan && !completed ? (
                      <Link href={`/pace/plan/${plan.id}`} className="activity-plan-pill">
